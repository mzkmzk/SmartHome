...
void loop () {
 ...
 Serial.println("----------");
  ...
  Serial.print(DHT.humidity,1);  //shidu
  Serial.print("\t");  
  Serial.println(DHT.temperature);  //wendu
   // String canshu ="updateKongTiao?deviceid=7&status="+ (int)DHT.temperature;
    Serial.println((int)DHT.temperature);
        char   str3[40]; 
           // String WenDu_Strring =DHT.temperature+"";
          //char   str2[] =DHT.temperature ;  
          WenDu__=(int)DHT.temperature;
          char str10[10];
          sprintf(str10,"%d",(int)DHT.temperature);
          //sprintf(str2,"%d",(int)DHT.temperature);
          char   str1[50]="updateKongTiao?deviceid=7&status=";
         // strcpy(str3,str1);  
          strcat(str1,str10); 
         Serial.println(str10[0]) ;
         Serial.println(str10[1]) ;
          //strcat(str1);
    //sprintf(p,"updateKongTiao?deviceid=7&status=%d",(int)DHT.temperature);
    //sprintf(p,"updateKongTiao?deviceid=7&status=26");
    //Serial.println(str1);
