...
char urlBuf2[] PROGMEM = "/v1.0/device/12495/sensor/20321/datapoints";//填写自己的传感器和设备信息
 
char urlBuf1[] PROGMEM = "/v1.0/device/12495/sensor/20320/";
 
char apiKey[] PROGMEM = "U-ApiKey:6c6d9f735da71052f2967a8efe4ad1b9";//填写自己的API key
...
static void my_result_cb1 (byte status, word off, word len) {
  ...
  String reply=(const char*)Ethernet::buffer + off + 326;
