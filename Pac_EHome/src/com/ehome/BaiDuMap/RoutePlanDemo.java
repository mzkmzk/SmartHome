...
//import com.ephone.BaiDuMap.MapControlDemo.locationOverlay;
import com.ehome.R;
/**
...
public class RoutePlanDemo extends Activity {
	...
	private TextView  lijia = null;//离家距离
	...
	protected void onCreate(Bundle savedInstanceState) {
       ...
       // mBtnCusIcon = (Button)findViewById(R.id.customicon);
		...
		lijia =(TextView)findViewById(R.id.lijia);
        //按键点击事件
...
//					ArrayList<MKCityListInfo> enCities = res.getAddrResult().mEndCityList;
	...
	void SearchButtonProcess(View v) {
		...
		//double  dimensionality= Double.parseDouble(extras.getString("dimensionality"));
		//double  longitude= Double.parseDouble(extras.getString("longitude"));
		double  dimensionality= Double.parseDouble("39.168590");
		double  longitude= Double.parseDouble("117.250306");
		...
		enNode.pt=new GeoPoint((int)(38.890126*1000000),(int)(117.161955*1000000));//终点
		stNode.pt=new GeoPoint((int)(38.890716*1000000),(int)(117.160625*1000000));//起点
 
		
		

		//double distance = DistanceUtil.getDistance(stNode.pt, enNode.pt);
		lijia.setText("离家:"+100+"米");
