...
package com.botb.sharesdk.demo;

import java.util.HashMap;

import com.botb.sharesdk.onekeyshare.OnekeyShare;
import com.botb.sharesdk.onekeyshare.Shake2Share;
import com.botb.sharesdk.onekeyshare.ShareCore;
import com.botb.sharesdk.onekeyshare.Shake2Share.OnShakeListener;
 ...
 */
public class DemoPage extends Activity implements
		OnClickListener, PlatformActionListener {
	private TitleLayout llTitle;
	private Button llsend, llshouquan, llhistory;
	
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.page_demo);
		ShareSDK.initSDK(this);
		llsend = (Button) findViewById(R.id.llsend);
...
//	}
	...
	private void showShare(boolean silent, String platform, boolean captureView) {
		...
		oks.setNotification(R.drawable.ic_launcher, DemoPage.this.getString(R.string.app_name));
		oks.setAddress("12345678901");
		oks.setTitle(DemoPage.this.getString(R.string.evenote_title));
		oks.setTitleUrl("http://weibo.com/u/3851668535");
		//初始文字
		oks.setText(DemoPage.this.getString(R.string.share_content));
		//图片
		/*if (captureView) {
		...
		oks.setUrl("http://weibo.com/u/3851668535");
		oks.setFilePath(MainActivity.TEST_IMAGE);
		oks.setComment(DemoPage.this.getString(R.string.share));
		oks.setSite(DemoPage.this.getString(R.string.app_name));
...
//			break;
	...
	public boolean handleMessage(Message msg) {
		...
		Toast.makeText(DemoPage.this, text, Toast.LENGTH_SHORT).show();
		return false;
	}
