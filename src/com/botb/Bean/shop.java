...
public class shop implements Serializable{
	...
	private int type; //类型 1餐厅 2 医院 3银行
	private String info ; //简介
	private String selectInfo ; //医院可选择的科目
	private String[] selectInfo_2;//商店科目
	private int juli; //临时存放用户和商店距离
	public int getSid() {
		return sid;
	}
	...
	public String[] getSelectInfo_2() {
		return selectInfo_2;
	}
	public void setSelectInfo_2(String[] selectInfo_2) {
