...
public class LeaveHomeActivity extends BaseActivity{
	...
	private TextView top_title,text_leavehome_distance;
	private RelativeLayout layout_leavehome_distance;
	...
	//	toggleButton_camera = (ToggleButton) findViewById(R.id.toggleButton_camera);
		...
		layout_leavehome_distance = (RelativeLayout) findViewById(R.id.layout_leavehome_distance);
		text_leavehome_distance = (TextView) findViewById(R.id.text_leavehome_distance);
	}
...
toggleButton_tv.setOnCheckedChangeListener(Button_tv);
		layout_leavehome_distance.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
            	showDialog(nick);
            }
		...
		case nick:
			...
			buttonnickyes.setOnClickListener(new Button.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					text_leavehome_distance.setText(cushion_time);
					ad2.dismiss();
				}
			});
